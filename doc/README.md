...
В нашем случае этот инструмент - язык программирования Python.
...
Детали которые оставляем без объяснения
...
Объяснить ключевое слово `import`.
Объяснить разделение имен точкой и иерархию библиотек.
