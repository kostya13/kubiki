...
Цель курса научить писать программы т.е. оценка задачи, разбиение на подзадачи, структурирование программы. 

Питон используется как простой язык, в котором прячутся много деталей реализации, и они не отвлекают от сути задачи. 
